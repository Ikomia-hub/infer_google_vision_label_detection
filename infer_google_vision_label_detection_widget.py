...
from infer_google_vision_label_detection.infer_google_vision_label_detection_process import InferGoogleVisionLabelDetectionParam
...
# --------------------
class InferGoogleVisionLabelDetectionWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferGoogleVisionLabelDetectionParam()
        else:
...
# --------------------
class InferGoogleVisionLabelDetectionWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_google_vision_label_detection"

    def create(self, param):
        # Create widget object
        return InferGoogleVisionLabelDetectionWidget(param, None)
